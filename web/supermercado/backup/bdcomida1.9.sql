...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-11-2022 a las 08:01:21
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `obtenerNotificaciones` ()  NO SQL
SELECT * FROM tbnotificacion WHERE notificacionestado = 0$$
...
--
-- Volcado de datos para la tabla `tbnotificacion`
--

INSERT INTO `tbnotificacion` (`notificacionid`, `notificacionordenid`, `notificacionestado`) VALUES
(2, 4, 1),
(3, 4, 1),
(4, 4, 1),
(5, 5, 1),
...
--
ALTER TABLE `tbnotificacion`
  MODIFY `notificacionid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
